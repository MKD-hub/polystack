...
const cube = @import("../3d/primitives/cube.zig").cube;
...
pub fn makeGizmoViewMat(g_context: *context) *[16]f32 {
...
pub fn makeGizmoPerspectiveMat(g_context: *context) *[16]f32 {
    const fov: f32 = 45 * (std.math.pi / 180.0);
    ...
    utils.flattenMat4ToF32Array(proj_mat, &g_context.gizmo_perspective_mat);
